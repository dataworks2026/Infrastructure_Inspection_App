  ...
  return (
    <div>
      ...
      <div className="text-center py-20 bg-white border border-slate-200 rounded-2xl shadow-card">
        ...
        <p className="text-lg font-medium text-slate-500">Report Generation Coming Soon</p>
        <p className="text-base text-mira-faint mt-1 max-w-sm mx-auto">
          This feature will be available in Phase 1.5. Complete inspections via the Upload page to start generating reports.
        </p>
        <div className="flex items-center justify-center gap-2 mt-4 text-sm text-mira-faint">
          <Clock size={14} /> Expected in next release
        </div>
      </div>
    </div>
  );
